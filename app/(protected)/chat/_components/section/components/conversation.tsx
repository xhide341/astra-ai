        ...
        <div className="p-4 space-y-4">
            {isLoadingConversation ? (
                <div className="absolute inset-0 flex items-center justify-center">
                    <BeatLoader size={12} color="#10b981" speedMultiplier={0.7} />
                </div>
            ) : (
                <>
                        ...
                        >
                            <div className="flex-shrink-0">
                                <div className={cn(
                                    ...
                                    message.role === "TEACHER" ? "bg-blue-500" : 
                                    message.role === "FACILITATOR" ? "bg-teal" :
                                    "bg-gray-500" // For USER role
                                )}>
                                    <span className="text-white text-sm font-semibold">
                                        {message.role === "TEACHER" ? "T" : 
                                         message.role === "FACILITATOR" ? "F" : 
                                         "U"}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className={cn(
                                ...
                                message.role === "TEACHER" ? "bg-blue-50" : "bg-teal-50"
                            )}>
                                <ReactMarkdown
                    ...
                    {isLoading && (
                        <div className="flex items-start gap-x-2">
                            ...
                            <div className="py-3 pl-0">
                                <BeatLoader size={8} color="#10b981" speedMultiplier={0.7} />
                            </div>
                        </div>
                    )}
                </>
