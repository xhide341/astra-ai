...
const ChatSection = () => {
  const { isCompact, error, isSidebarOpen, activeChat, toggleSidebar } =
    useChatStore();
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center h-full">
              <div className="w-full max-w-md">
                ...
                <p className="text-slate-800 dark:text-white/90 text-xs font-regular mx-auto mb-6 text-center max-w-sm">
                  Please ask with WH(Who/What/How/Where) questions for better
                  results.
                </p>
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-zinc-800">
              ...
              <h2 className="px-6 max-w-2xl w-full text-xl font-semibold mx-auto text-start text-black-600 dark:text-white/90 flex items-center gap-2">
                ...
                {activeChat ? `Topic: ${activeChat.title}` : "New Chat"}
              </h2>
